...
def read_standard_book_to_lmdb_book(lmdb_connection : book_lmdb.LMDBConnection, read_path : str , ignore_depth:bool, progress:bool=False, intermediate_reopen:bool=False):
    """
